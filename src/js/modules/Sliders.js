...
const Sliders = (function () {
  ...
  const sliderAbout3 = $(".js-about-slider3");
  ...
  const sliderReviewsProd = $(".js-reviews-list-product");
  return {
    ...
    initReviewsMainSlider: function () {
    ...
    initReviewsProdSlider: function () {
      sliderReviewsProd.slick({
        adaptiveHeight: true,
        rows: 5,
        arrows: false,
        dots: true,
        appendDots: $(".js-reviews-pagination-product"),
        dotsClass: "pagination__item slick-dots slick-dots--dark",
      });
    },
    initKnowledgeSlider: function () {
      for (let i = 0; i < $(".article").length; i++) {
        $(
          ".article-knowledge--" + (i + 1) + " .article--" + (i + 1) + ""
        ).remove();
      }
    ...
    init: function () {
      ...
      Sliders.initAboutSlider3();
      Sliders.initReviewsSlider();
      Sliders.initReviewsMainSlider();
      Sliders.initReviewsProdSlider();
